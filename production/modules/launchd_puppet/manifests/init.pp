...
class launchd_puppet {
    ...
    file { 'puppet-run':
        ...
        path    => '/Library/PrivilegedHelperTools/edu.bethel.puppet/puppet-run',
        source  => 'puppet:///modules/launchd_puppet/puppet-run',
        mode    => 'u+x',
        owner   => root,
        group   => wheel,
    }
    launchd::job {'edu.bethel.puppet':
        ...
        program => '/Library/PrivilegedHelperTools/edu.bethel.puppet/puppet-run',
        run_at_load => true,
	start_interval => 1800,
    }
}
